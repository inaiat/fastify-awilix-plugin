...
import { Cradle, DiContainer } from '.'

export const defaultInjectionMode: InjectionModeType = 'PROXY'
...
export function setupAwilixDecorator(fastify: FastifyInstance, diContainer: DiContainer) {
